...
## Komara Agency Integration

This repo integrates Prime Agent with Komara Agency's bot ecosystem:

### Connected Agents
1. **Telegram Bot** — @Komara_Agency_botbot (active 24/7)
2. **Facebook Messenger** — N-dine K fans page (polling 3x/day)
3. **Instagram DM** — pending (Business account required)
4. **WhatsApp Business** — +212 701-986219

### Agent Communication Architecture
```
┌─────────────────┐     ┌─────────────────┐     ┌─────────────────┐
│   Telegram Bot  │     │  FB Messenger   │     │  WhatsApp Bot   │
│   @Komara_Agency│     │  N-dine K fans  │     │  +212 701-...   │
└────────┬────────┘     └────────┬────────┘     └────────┬────────┘
         │                       │                       │
         └───────────┬───────────┴───────────────────────┘
                     │
...
### Knowledge Base
- Agency: Komara Agency 🇬🇳 — Vision. Impact. Excellence.
- Services: Logo, Affiche, Retouche Photo, Bots, Branding, Montage Vidéo
- Pricing: Logo 300k-500k GNF, Affiche 300k GNF, Express +30%
- Contact: +212 701-986219 | ndinekomara2442@gmail.com
